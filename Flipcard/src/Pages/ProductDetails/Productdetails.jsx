  ...
  return (
    <div className='Productdetails'>
      <div className='Productdetails-left'>
        ...
        <div className='ProductDetail-Img'>
          ...
          <div className='ProductDetail-btns'>
            <button className='ProductDetail-btn' onClick={addToCard}>
      ...
      <div className='Productdetails-right'>
        ...
        <p className='price'>₹{data.Sellingprice}
        </p>
        <p className='packfee'>+ ₹69 Secured Packing Fee</p>
        <p className='availableoff'>Available offers</p>
        <div className='offers'>
          <img src="https://rukminim1.flixcart.com/www/36/36/promos/06/09/2016/c22c9fc4-0555-4460-8401-bf5c28d7ba29.png?q=90" height={20} alt="" />
          
          <div>
            <b>
            Bank Offer
          </b> 5% Cachback on Flipcard Axis Bank CardT&C
        ...
        <div className='offers'>
          ...
          <div>
            <b>
            Partner Offer
          </b> Purchase now & get a surprise cashback coupon for January / Febuary 2023Know More
        ...
        <div className='offers'>
          ...
          <div>
             <b>
            Partner Offer
          </b> Sign up for Flipcard Pay Later and get Flipcard Gift Card worth up to ₹500✦Know More

          </div>
          
        </div>
        <div className='offers'>
          <img src="https://rukminim1.flixcart.com/www/36/36/promos/06/09/2016/49f16fff-0a9d-48bf-a6e6-5980c9852f11.png?q=90" height={20} alt="" />
          
          <div>
            <b>
            EMI starting
          </b> from ₹832/monthView Plans
        ...
        <div className='RatingAndReviews'>
          <p className='RatingAndReviews-title'>Ratings & Reviews
          ...
          <div className='RatingAndReviews-container'>
            <div className='RatingAndReviews-stars'>
              ...
              <p className='RatingAndReviews-rating'> {data.rating} Ratings & {data.reviews} Reviews</p>
            </div>
            <div className='RatingAndReviews-charts'>
              <li className='ratingbar'>
